...
.grid{{max-width:1000px;margin:0 auto;padding:6px 20px 10px;display:grid;grid-template-columns:repeat(auto-fill,minmax(155px,1fr));gap:16px}}
...
.meta{{padding:11px 12px 13px}} .cname{{font-weight:700;margin-bottom:3px}} .hint{{font-size:11px;color:#8b93a7;margin-bottom:7px}}
...
@media(max-width:520px){{h1{{font-size:27px}} .hero{{padding:26px 16px 4px}} .lede{{font-size:15px}} .grid{{grid-template-columns:repeat(2,1fr);gap:11px;padding:6px 12px}} .stats{{gap:8px;padding:16px 12px}} .stat{{padding:9px 12px;min-width:0;flex:1}} .stat .n{{font-size:18px}} .stat .l{{font-size:10px}} .cta{{display:block;margin:0 14px}} .cname{{font-size:14px}} .lk{{font-size:11px;padding:4px 8px}} .starter{{margin:14px 14px 0}} .top{{padding:13px 16px}} .back{{padding:6px 10px;font-size:12px}}}}
</style></head><body>
